...
---@param keymap string | nil the keymap to trigger the telescope picker. Defaults to '<leader>sc'
M.setup = function(keymap)
  vim.keymap.set("n", keymap or "<leader>sc", function()
    pick_list("")
